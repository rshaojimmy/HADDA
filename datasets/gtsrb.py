...
class GTSRB(data.Dataset):
    ...
    split_list = {
        ...
        'train': ["GTSRB_train_32x32.mat"],
        'test': ["GTSRB_test_32x32.mat"]}
...
def get_gtsrb(train, get_dataset=False, batch_size=cfg.batch_size):
    ...
    gtsrb_dataset = GTSRB(root=cfg.data_root,
                                 split='train' if train else 'test',
                                 transform=pre_process,
                                 download=False)

    if get_dataset:
        return gtsrb_dataset
    else:
        gtsrb_data_loader = torch.utils.data.DataLoader(
            dataset=gtsrb_dataset,
            batch_size=batch_size,
            shuffle=True)
        return gtsrb_data_loader